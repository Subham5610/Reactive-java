...
public class Exercise1 {
    ...
    public static void main(String[] args) {
        ...
        StreamSources.intNumbersStream().filter(number -> number < 5).forEach(e -> System.out.println(e));
        System.out.println();
        // Print the second and third numbers in intNumbersStream that's greater than 5
        StreamSources.intNumbersStream().filter(number -> number > 5).skip(1).limit(2).forEach(e -> System.out.println(e));
        System.out.println();
